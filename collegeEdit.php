...
<div class="modal">
    ...
    <form id="editForm">
        <input type="hidden" name="old_college_code" value="<?= $college['college_code'] ?>">
        ...
        <div class="btn-group">
            <button type="submit" class="btn-submit" id="submitBtn">Edit College</button>
        ...
        $("#editForm").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $("#resultBox").show();
                    if (data.success) {
                        $("#resultBox").removeClass("error").addClass("success").text("✓ College updated successfully!");
                        $("#submitBtn").hide();
                        $("#cancelBtn").text("Go Back").attr("href", "Colleges.php");
                    } else {
                        $("#resultBox").removeClass("success").addClass("error").text("✗ " + data.error);
                        $("#submitBtn").prop("disabled", false).text("Edit College");
                    }
                },
                error: function () {
